...
public class Ejercicios {
	//Trabaje en grupo con las siguientes personas:
	//Mi Persona Iveth Sabillon, Kevin Lanza,Maynor,Walter,ALex,Maverick del Cid 
	...
	//se declara y inicializamos la variable
	//por medio de un while se hace el proceso para ver cuantas veces esta la variable
	//y nos devuelve la variable buscada
